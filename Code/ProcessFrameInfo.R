...
data <- read.csv(paste("../Data/Frames/",FileName,"/annotations.csv", sep=""))
...
write.csv(data, file=paste("../Data/Frames/",FileName,"/FramesLong.csv", sep=""))
...
write.csv(DataShort, file=paste("../Data/Frames/",FileName,"/FramesShort.csv", sep=""))
